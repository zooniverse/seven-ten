RSpec.describe DataRequestSerializer, type: :serializer do
  ...
  describe '#attributes' do
    ...
    its([:created_at]){ is_expected.to be_within(1.second).of data_request.created_at }
    its([:updated_at]){ is_expected.to be_within(1.second).of data_request.updated_at }
  end
